exports.config = {
  ...
  files: {
    javascripts: {
      ...
      //  "dist/photoswipe.min.js": /^(web\/static\/vendor\/photoswipe)/,
      //  "dist/-ui-default.min.js": /^(web\/static\/vendor\/photoswipe)/,
      //}
      //
      // To change the order of concatenation of files, explicitly mention here
      //order: {
      //  before: [
          //"web/static/vendor/threecol/js/jquery.js",
          //"web/static/vendor/threecol/fonts/glyphicons-halflings-regular.woff2",
        //]
      //}
    },
    stylesheets: {
